...
describe("to_rgb8", function()
  it("converts normalized RGB to 8-bit RGB", function()
    local r8, g8, b8 = Format.to_rgb8(0.5, 0.25, 0.75)
  ...
  it("handles boundary values", function()
    local r8, g8, b8 = Format.to_rgb8(0.0, 1.0, 0.5)
    assert.equals(0, r8)
  ...
  it("clamps out-of-range values", function()
    local r8, g8, b8 = Format.to_rgb8(-0.1, 1.5, 0.5)
    assert.equals(0, r8)
    assert.equals(255, g8)
    assert.equals(128, b8)
  end)
...
describe("from_rgb8", function()
  it("converts 8-bit RGB to normalized RGB", function()
    local r, g, b = Format.from_rgb8(128, 64, 191)
  ...
  it("handles boundary values", function()
    local r, g, b = Format.from_rgb8(0, 255, 128)
...
describe("to_rgb16", function()
  it("converts normalized RGB to 16-bit RGB", function()
    local r16, g16, b16 = Format.to_rgb16(0.5, 0.25, 0.75)
  ...
  it("handles boundary values", function()
    local r16, g16, b16 = Format.to_rgb16(0.0, 1.0, 0.5)
    assert.equals(0, r16)
  ...
  it("clamps out-of-range values", function()
    local r16, g16, b16 = Format.to_rgb16(-0.1, 1.5, 0.5)
    assert.equals(0, r16)
    assert.equals(65535, g16)
    assert.equals(32768, b16)
  end)
...
describe("from_rgb16", function()
  it("converts 16-bit RGB to normalized RGB", function()
    local r, g, b = Format.from_rgb16(32768, 16384, 49151)
  ...
  it("handles boundary values", function()
    local r, g, b = Format.from_rgb16(0, 65535, 32768)
    spec_helper.assert_near(0.0, r, 1e-10)
    spec_helper.assert_near(1.0, g, 1e-10)
...
describe("clamp_rgb8", function()
  it("clamps RGB values to 8-bit range", function()
    local r8, g8, b8 = Format.clamp_rgb8(128, 64, 191)
  ...
  it("handles boundary values", function()
    local r8, g8, b8 = Format.clamp_rgb8(0, 255, 128)
  ...
  it("clamps out-of-range values", function()
    local r8, g8, b8 = Format.clamp_rgb8(-10, 300, 128)
    assert.are.equal(0, r8)
    assert.are.equal(255, g8)
    assert.are.equal(128, b8)
  end)
  ...
  it("clamps fractional values to range", function()
    local r8, g8, b8 = Format.clamp_rgb8(1.2, 2.7, 3.9)
...
describe("clamp_rgb16", function()
  it("clamps RGB values to 16-bit range", function()
    local r16, g16, b16 = Format.clamp_rgb16(32768, 16384, 49151)
  ...
  it("handles boundary values", function()
    local r16, g16, b16 = Format.clamp_rgb16(0, 65535, 32768)
  ...
  it("clamps out-of-range values", function()
    local r16, g16, b16 = Format.clamp_rgb16(-1000, 70000, 32768)
    assert.are.equal(0, r16)
    assert.are.equal(65535, g16)
    assert.are.equal(32768, b16)
  end)
  ...
  it("clamps fractional values to range", function()
    local r16, g16, b16 = Format.clamp_rgb16(1.2, 2.7, 3.9)
...
describe("round_rgb", function()
  it("rounds RGB values to integers", function()
    local r, g, b = Format.round_rgb(1.2, 2.7, 3.9)
  ...
  it("handles integer values", function()
    local r, g, b = Format.round_rgb(5, 10, 15)
...
describe("to_rgb100", function()
  it("converts 0.0 to 0% with tolerance", function()
    local r = Format.to_rgb100(0.0, 0.0, 0.0)
    spec_helper.assert_near(0.0, r, 1e-10)
  end)

  it("converts 0.5 to 50% with tolerance", function()
    local r, g, b = Format.to_rgb100(0.5, 0.5, 0.5)
  ...
  it("converts 1.0 to 100% with tolerance", function()
    local r, g, b = Format.to_rgb100(1.0, 1.0, 1.0)
  ...
  it("converts three values with tolerance", function()
    local r, g, b = Format.to_rgb100(0.5, 0.25, 0.75)
    spec_helper.assert_near(50.0, r, 1e-10)
  ...
  it("handles boundary 0.0", function()
    local r, g, b = Format.to_rgb100(0.0, 0.0, 0.0)
    spec_helper.assert_near(0.0, r, 1e-10)
...
describe("from_rgb100", function()
  it("converts 0% to 0.0 with tolerance", function()
    local r, g, b = Format.from_rgb100(0.0, 0.0, 0.0)
    spec_helper.assert_near(0.0, r, 1e-10)
    spec_helper.assert_near(0.0, g, 1e-10)
    spec_helper.assert_near(0.0, b, 1e-10)
  end)
  ...
  it("converts 50% to 0.5 with tolerance", function()
    local r, g, b = Format.from_rgb100(50.0, 50.0, 50.0)
  ...
  it("converts 100% to 1.0 with tolerance", function()
    local r, g, b = Format.from_rgb100(100.0, 100.0, 100.0)
  ...
  it("converts three values with tolerance", function()
    local r, g, b = Format.from_rgb100(50.0, 25.0, 75.0)
    spec_helper.assert_near(0.5, r, 1e-10)
