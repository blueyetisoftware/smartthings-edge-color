...
describe("clamp_hff", function()
  it("wraps hue modulo 1 and clamps other values", function()
    local h, s, v = Hue.clamp_hff(1.5, 0.8, 0.6)
  ...
  it("handles negative hue values", function()
    local h, s, v = Hue.clamp_hff(-0.3, 0.5, 0.7)
  ...
  it("clamps saturation/value to [0, 1]", function()
    local h, s, v = Hue.clamp_hff(0.2, -0.1, 1.2)
  ...
  it("handles boundary values", function()
    local h, s, v = Hue.clamp_hff(0, 0, 0)
...
describe("clamp_hdff", function()
  it("wraps degrees hue modulo 360 and clamps other values", function()
    local h, s, v = Hue.clamp_hdff(450, 0.8, 0.6)  -- 450 % 360 = 90
  ...
  it("handles negative degrees", function()
    local h, s, v = Hue.clamp_hdff(-90, 0.5, 0.7)  -- -90 % 360 = 270
  ...
  it("clamps saturation/value to [0, 1]", function()
    local h, s, v = Hue.clamp_hdff(180, -0.1, 1.2)
...
describe("to_hdff", function()
  it("converts normalized hue to degrees", function()
    local h, s, v = Hue.to_hdff(0.5, 0.8, 0.6)  -- 0.5 * 360 = 180
    assert.are.equal(180, h)
    assert.are.equal(0.8, s)
    assert.are.equal(0.6, v)
  end)
  ...
  it("wraps converted degrees", function()
    local h, s, v = Hue.to_hdff(1.25, 0.5, 0.7)  -- 1.25 * 360 = 450, 450 % 360 = 90
    assert.are.equal(90, h)
    assert.are.equal(0.5, s)
    assert.are.equal(0.7, v)
  end)
  ...
  it("clamps saturation/value", function()
    local h, s, v = Hue.to_hdff(0.3, 1.2, -0.1)
...
describe("from_hdff", function()
  it("converts degrees hue to normalized", function()
    local h, s, v = Hue.from_hdff(180, 0.8, 0.6)  -- 180 / 360 = 0.5
  ...
  it("wraps converted normalized hue", function()
    local h, s, v = Hue.from_hdff(450, 0.5, 0.7)  -- 450 / 360 = 1.25, 1.25 % 1 = 0.25
  ...
  it("clamps saturation/value", function()
    local h, s, v = Hue.from_hdff(90, 1.2, -0.1)
