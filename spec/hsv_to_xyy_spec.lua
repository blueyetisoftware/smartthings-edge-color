...
describe("hsv_to_xyy", function()
  it("converts HSV to xyY with valid ranges", function()
    local x, y, Y = hsv_to_xyy(0.5, 0.5)
  ...
  it("defaults v to 1.0 when omitted", function()
    local x1, y1, Y1 = hsv_to_xyy(0.5, 0.5, 1.0)
    local x2, y2, Y2 = hsv_to_xyy(0.5, 0.5)
