...
--- xyY to RGB using the xyy_to_rgb function, then converting RGB to HSV using the
...
---
--- @usage
--- local h, s, v = xyy_to_hsv(0.3127, 0.3290, 0.8)  -- D65 white point with 80% luminance
--- local h, s, v = xyy_to_hsv(0.6400, 0.3300, 1.0)  -- sRGB red primary
local function xyy_to_hsv(x, y, Y)
