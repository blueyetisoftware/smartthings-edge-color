...
Color.xyy_to_cct = require 'color.xyy_to_cct'
Color.cct_to_xyy = require 'color.cct_to_xyy'
Color.xyy_to_hsv = require 'color.xyy_to_hsv'
Color.hsv_to_xyy = require 'color.hsv_to_xyy'
...
Color.rgb_to_xyy = require 'color.rgb_to_xyy'
Color.xyy_to_rgb = require 'color.xyy_to_rgb'
