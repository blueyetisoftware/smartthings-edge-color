...
--- by first converting CCT to CIE 1931 xyY coordinates using the cct_to_xyy function,
--- then converting xyY to HSV using the xyy_to_hsv function. The resulting HSV represents
...
local function cct_to_hsv(cct)
    ...
    return clamp_hff(xyy_to_hsv(cct_to_xyy(cct)))
end
