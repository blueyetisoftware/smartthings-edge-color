...
local function to_8bit(a, b, c)
    ...
    if c ~= nil then
        return st_utils.clamp_value(st_utils.round(a * 255.0), 0, 255), st_utils.clamp_value(st_utils.round(b * 255.0), 0, 255), st_utils.clamp_value(st_utils.round(c * 255.0), 0, 255)
    elseif b ~= nil then
        return st_utils.clamp_value(st_utils.round(a * 255.0), 0, 255), st_utils.clamp_value(st_utils.round(b * 255.0), 0, 255)
    else
        return st_utils.clamp_value(st_utils.round(a * 255.0), 0, 255)
    end
end
